        ...
        <section className="relative w-full md:w-1/2 min-h-[60vh] md:min-h-0 md:h-full flex items-center justify-center overflow-hidden py-16 md:py-0">
          ...
          <div className="relative z-10 flex flex-col justify-center items-center">
            ...
            <motion.span
              ...
              className="mt-[10px] font-sans font-light text-[18px] tracking-[0.25em] text-neutral-800 uppercase"
            >
              Coming Soon
            </motion.span>
          </div>
          ...
          >
            ...
            >
              ...
              />
              <span className="font-sans text-[16px] md:text-[18px] tracking-[0.2em] text-neutral-800 uppercase">
                scroll
              </span>
              <svg
                width="20"
            ...
            <nav className="flex flex-col items-end justify-center h-full pr-10 md:pr-16 gap-[6px] md:gap-[8px]">
              {NAV_ITEMS.map((item) => (
                <TransitionLink
                  key={item.href}
                  href={item.href}
                  className="group relative font-sans text-[26px] md:text-[32px] leading-tight text-[#FBFFFF] transition-colors duration-500 hover:text-[#C0CCFC]"
                >
                  {item.label}
